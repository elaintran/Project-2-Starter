...
let gameManager = { // eslint-disable-line no-unused-vars
  ...
  //   console.log("Create character was run.");
    // switch (classType) {
    //   case "Swordmaster": 
    //     // this.createSwordsmaster();
    ...
    // }
  // },
  // createSwordsmaster: function(chapter){
  //   switch (chapter){
  //     case "1":
  //         character = new Character(classType, 25, 25, 37.5, 37.5);
  //         console.log("Level 1 swordsmaster created!");
  //         break;
  //     case "2":
  //         character = new Character(classType, 40, 40, 52, 52);
  //         console.log("Level 1 swordsmaster created!");
  //         break;
  //     case "3":
  //         character = new Character(classType, 55, 55, 67, 67);
  //         console.log("Level 1 swordsmaster created!");
  //         break;
  //   }
  // },
